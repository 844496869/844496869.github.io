...
<source src="../assets/img/git/git-apt-install.mp4">
</video>
...
![install-git-by-xcode](../assets/img/git/12-05-15-49-01.jpg)
...
msysgit是Windows版的Git，从[git-for-windows](https://git-for-windows.github.io)下载（网速慢的同学请移步国内镜像），然后按默认选项安装即可。

安装完成后，在开始菜单里找到“Git”->“Git Bash”，蹦出一个类似命令行窗口的东西，就说明Git安装成功！

![install-git-on-windows](../assets/img/git/12-05-15-49-02.jpg)
